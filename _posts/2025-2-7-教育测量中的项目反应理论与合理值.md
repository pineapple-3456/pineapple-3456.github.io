...
![figure1](/assets/img/教育测量中的合理值figure1.png #pic_center "figure1"){:height="70%" width="70%"}
...
![figure2](/assets/img/教育测量中的合理值figure2.png #pic_center "figure2"){:height="70%" width="70%"}
...
![figure3](/assets/img/教育测量中的合理值figure3.png #pic_center "figure3"){:height="70%" width="70%"}
...
其中 $$f(x|\theta)$$ 是学生能力为 $$\theta$$ 时做出反应序列 $$x$$ 的概率。 $$g(\theta)$$ 是能力的先验分布，在LSA中一般是一个国家或地区的学生能力分布。 $$f(x)$$ 是不考虑能力的反应序列分布。

通过学生能力的后验分布，也可以计算各国家或地区的学生能力分布：

$$
\begin{align}
g(\theta)=\int h(\theta|x) f(\bm{x}) d x
\end{align}
$$
